...
public class TeamLeader extends Person {
	...
	/*
	 * public void setPassword(String currPassword, String newPassword) throws
	 * Exception { if (password.equals(currPassword)) { this.password = newPassword;
	...
	public static void main(String[] args) {
		TeamLeader Teako = new TeamLeader("Teakosheen", "TK", 1, 7, 1983);
		Teako.setPassword("123");
